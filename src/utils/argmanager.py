...
scoring_args = {
    ...
    ("-scout", "--scoring-output-dir",): {"type": str, "help": "The dir that will used for all output files like: <output-dir>/<sample_name>.<index>.variant_scores.tsv; directory should already exist.", "required": True},
