...
subcommand_args = {
    "score": {
        ...
        "args": {
            ...
            ("-scdir", "--score-dir"): {"type": str, "help": "The directory to store scoring files. Used in this way: <score-dir>/<model-name>/fold_<index>.variant_scores.tsv. Directory should already exist.", "required": True},
